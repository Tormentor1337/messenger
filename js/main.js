...
function Counter(props) {
  ...
  return /*#__PURE__*/react.createElement("div", Object.assign({}, restProps, {
    className: classnames_default()('Counter', className)
  }), children);
}
...
function Navbar(props) {
  var children = props.children,
      className = props.className,
      restProps = Navbar_objectWithoutProperties(props, ["children", "className"]);

  return /*#__PURE__*/react.createElement("div", Object.assign({}, restProps, {
    className: classnames_default()('Navbar', className)
  }), children);
}
;// CONCATENATED MODULE: ./src/components/NavbarItem/NavbarItem.tsx
...
function NavbarItem(props) {
  var active = props.active,
      ...
      className = props.className,
      restProps = NavbarItem_objectWithoutProperties(props, ["active", "children", "text", "counter", "className"]);

  return /*#__PURE__*/react.createElement("div", Object.assign({}, restProps, {
    className: classnames_default()('NavbarItem', {
      'NavbarItem--active': active
    }, className)
  }), /*#__PURE__*/react.createElement("div", {
    className: "NavbarItem__icon"
  }, counter && /*#__PURE__*/react.createElement("div", {
    className: "NavbarItem__counter"
  }, counter), children), /*#__PURE__*/react.createElement("div", {
...
function Spinner(props) {
  var className = props.className,
      restProps = Spinner_objectWithoutProperties(props, ["className"]);

  return /*#__PURE__*/react.createElement("div", Object.assign({}, restProps, {
    className: classnames_default()('Spinner', className)
  }));
}
...
function Panel(props) {
  var title = props.title,
      children = props.children,
      className = props.className,
      restProps = Panel_objectWithoutProperties(props, ["title", "children", "className"]);
  ...
  var createScroll = function createScroll() {
    var prev = 0,
        curr = 0;
    return function () {
      prev = curr;
  ...
  return /*#__PURE__*/react.createElement("div", Object.assign({}, restProps, {
    ...
    className: classnames_default()('Panel__header-in', {
      'Panel__header-in--fixed': isFixed
    })
  }, title)), /*#__PURE__*/react.createElement("div", {
...
function _toConsumableArray(arr) { return _arrayWithoutHoles(arr) || _iterableToArray(arr) || Root_unsupportedIterableToArray(arr) || _nonIterableSpread(); }

function _nonIterableSpread() { throw new TypeError("Invalid attempt to spread non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); }

function _iterableToArray(iter) { if (typeof Symbol !== "undefined" && Symbol.iterator in Object(iter)) return Array.from(iter); }

function _arrayWithoutHoles(arr) { if (Array.isArray(arr)) return Root_arrayLikeToArray(arr); }

function Root_slicedToArray(arr, i) { return Root_arrayWithHoles(arr) || Root_iterableToArrayLimit(arr, i) || Root_unsupportedIterableToArray(arr, i) || Root_nonIterableRest(); }

function Root_nonIterableRest() { throw new TypeError("Invalid attempt to destructure non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); }

function Root_unsupportedIterableToArray(o, minLen) { if (!o) return; if (typeof o === "string") return Root_arrayLikeToArray(o, minLen); var n = Object.prototype.toString.call(o).slice(8, -1); if (n === "Object" && o.constructor) n = o.constructor.name; if (n === "Map" || n === "Set") return Array.from(o); if (n === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)) return Root_arrayLikeToArray(o, minLen); }

function Root_arrayLikeToArray(arr, len) { if (len == null || len > arr.length) len = arr.length; for (var i = 0, arr2 = new Array(len); i < len; i++) { arr2[i] = arr[i]; } return arr2; }

function Root_iterableToArrayLimit(arr, i) { if (typeof Symbol === "undefined" || !(Symbol.iterator in Object(arr))) return; var _arr = []; var _n = true; var _d = false; var _e = undefined; try { for (var _i = arr[Symbol.iterator](), _s; !(_n = (_s = _i.next()).done); _n = true) { _arr.push(_s.value); if (i && _arr.length === i) break; } } catch (err) { _d = true; _e = err; } finally { try { if (!_n && _i["return"] != null) _i["return"](); } finally { if (_d) throw _e; } } return _arr; }

function Root_arrayWithHoles(arr) { if (Array.isArray(arr)) return arr; }

function Root_objectWithoutProperties(source, excluded) { if (source == null) return {}; var target = Root_objectWithoutPropertiesLoose(source, excluded); var key, i; if (Object.getOwnPropertySymbols) { var sourceSymbolKeys = Object.getOwnPropertySymbols(source); for (i = 0; i < sourceSymbolKeys.length; i++) { key = sourceSymbolKeys[i]; if (excluded.indexOf(key) >= 0) continue; if (!Object.prototype.propertyIsEnumerable.call(source, key)) continue; target[key] = source[key]; } } return target; }

function Root_objectWithoutPropertiesLoose(source, excluded) { if (source == null) return {}; var target = {}; var sourceKeys = Object.keys(source); var key, i; for (i = 0; i < sourceKeys.length; i++) { key = sourceKeys[i]; if (excluded.indexOf(key) >= 0) continue; target[key] = source[key]; } return target; }
...
function Root(props) {
  var activeView = props.activeView,
      ...
      navbar = props.navbar,
      className = props.className,
      restProps = Root_objectWithoutProperties(props, ["activeView", "children", "navbar", "className"]);

  var views = [].concat(children);

  var _useState = (0,react.useState)([]),
      _useState2 = Root_slicedToArray(_useState, 2),
      loaded = _useState2[0],
      setLoaded = _useState2[1];

  (0,react.useEffect)(function () {
    var active = views.find(function (x) {
      return x.props.id === activeView;
    });

    if (loaded.filter(function (x) {
      return x.props.id === active.props.id;
    }).length) {
      return;
    }

    setLoaded([].concat(_toConsumableArray(loaded), [active]));
  }, [activeView]);
  return /*#__PURE__*/react.createElement("div", Object.assign({}, restProps, {
    className: classnames_default()('Root', className)
  }), /*#__PURE__*/react.createElement("div", {
    className: "Root__content"
  }, loaded.map(function (view) {
    var isActive = view.props.id === activeView;
    return /*#__PURE__*/react.createElement("div", {
      className: classnames_default()('Root__loaded', {
        'Root__loaded--active': isActive
      }),
      key: view.props.id
    }, view);
  })), /*#__PURE__*/react.createElement("div", {
    className: "Root__navbar"
  }, /*#__PURE__*/react.createElement("div", {
    className: "Root__navbar-in"
  }, navbar)));
}
;// CONCATENATED MODULE: ./src/components/View/View.tsx
function View_objectWithoutProperties(source, excluded) { if (source == null) return {}; var target = View_objectWithoutPropertiesLoose(source, excluded); var key, i; if (Object.getOwnPropertySymbols) { var sourceSymbolKeys = Object.getOwnPropertySymbols(source); for (i = 0; i < sourceSymbolKeys.length; i++) { key = sourceSymbolKeys[i]; if (excluded.indexOf(key) >= 0) continue; if (!Object.prototype.propertyIsEnumerable.call(source, key)) continue; target[key] = source[key]; } } return target; }

function View_objectWithoutPropertiesLoose(source, excluded) { if (source == null) return {}; var target = {}; var sourceKeys = Object.keys(source); var key, i; for (i = 0; i < sourceKeys.length; i++) { key = sourceKeys[i]; if (excluded.indexOf(key) >= 0) continue; target[key] = source[key]; } return target; }
...
function View(props) {
  var children = props.children,
      className = props.className,
      restProps = View_objectWithoutProperties(props, ["children", "className"]);

  return /*#__PURE__*/react.createElement("div", Object.assign({}, restProps, {
    className: classnames_default()('View', className)
  }), children);
}
;// CONCATENATED MODULE: ./src/messenger.tsx
function messenger_slicedToArray(arr, i) { return messenger_arrayWithHoles(arr) || messenger_iterableToArrayLimit(arr, i) || messenger_unsupportedIterableToArray(arr, i) || messenger_nonIterableRest(); }

function messenger_nonIterableRest() { throw new TypeError("Invalid attempt to destructure non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); }

function messenger_unsupportedIterableToArray(o, minLen) { if (!o) return; if (typeof o === "string") return messenger_arrayLikeToArray(o, minLen); var n = Object.prototype.toString.call(o).slice(8, -1); if (n === "Object" && o.constructor) n = o.constructor.name; if (n === "Map" || n === "Set") return Array.from(o); if (n === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)) return messenger_arrayLikeToArray(o, minLen); }

function messenger_arrayLikeToArray(arr, len) { if (len == null || len > arr.length) len = arr.length; for (var i = 0, arr2 = new Array(len); i < len; i++) { arr2[i] = arr[i]; } return arr2; }

function messenger_iterableToArrayLimit(arr, i) { if (typeof Symbol === "undefined" || !(Symbol.iterator in Object(arr))) return; var _arr = []; var _n = true; var _d = false; var _e = undefined; try { for (var _i = arr[Symbol.iterator](), _s; !(_n = (_s = _i.next()).done); _n = true) { _arr.push(_s.value); if (i && _arr.length === i) break; } } catch (err) { _d = true; _e = err; } finally { try { if (!_n && _i["return"] != null) _i["return"](); } finally { if (_d) throw _e; } } return _arr; }

function messenger_arrayWithHoles(arr) { if (Array.isArray(arr)) return arr; }
...
var initPath = location.pathname.slice(1) || 'chats';

function Messenger() {
  var _useState = (0,react.useState)(initPath),
      _useState2 = messenger_slicedToArray(_useState, 2),
  ...
  return /*#__PURE__*/react.createElement(Root, {
    ...
    navbar: /*#__PURE__*/react.createElement(Navbar, null, /*#__PURE__*/react.createElement(NavbarItem, {
      text: "\u041D\u043E\u0432\u043E\u0441\u0442\u0438",
      ...
      counter: /*#__PURE__*/react.createElement(Counter, null, '3'),
      onClick: function onClick() {
        return go('chats');
      }
    }, /*#__PURE__*/react.createElement("svg", {
